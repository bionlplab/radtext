...
from radtext.models.ner.utils import longest_matching, remove_duplicates
...
class NerSpacyExtractor:
    ...
    def findall(self, text: str) -> List[NERMatch]:
        ...
        for match_id, start, end in doc.finditer_matcher(self.matcher):
            ...
            m = NERMatch()
            m.concept_id = self.nlp.vocab.strings[match_id]
            m.concept = self.id2pref[m.concept_id]
